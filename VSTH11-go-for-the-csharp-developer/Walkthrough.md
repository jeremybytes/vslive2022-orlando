...
func main() {
	...
	for i := 0; i < len(ids); i++ {
		selectedPerson := getPerson(ids[i])
		fmt.Printf("%d: %v\n", selectedPerson.ID, selectedPerson)
	}
}
```
